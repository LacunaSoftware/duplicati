...
namespace Duplicati.Library.Main.Strings
{
    ...
    internal static class Options
    {
        ...
        public static string EnotariadoAuthFileLong { get { return LC.L(@"JSON file that contains the necessary information for the application to authenticate with e-notariado servers. It must be a JSON with the following 3 properties: certThumbprint, applicationId, subscriptionId."); } }
        public static string EnotariadoAuthFileShort { get { return LC.L(@"JSON file that contains the necessary information for the application to authenticate with e-notariado servers."); } }
